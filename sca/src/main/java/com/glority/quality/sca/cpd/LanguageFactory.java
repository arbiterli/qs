...
public class LanguageFactory {
    ...
    public static String[] supportedLanguages = new String[] { "java", "jsp",
            "cpp", "c", "php", "ruby", "fortran", "ecmascript", "cs",
            "javascript", "css" };

    private static final String SUFFIX = "Language";
    public static final String EXTENSION = "extension";
    public static final String BY_EXTENSION = "by_extension";
    private static final String PACKAGE = "com.glority.quality.sca.cpd.";
    ...
    public Language createLanguage(String language, Properties properties) {
        ...
        try {
            implementation = this.dynamicLanguageImplementationLoad(this
                    .languageConventionSyntax(language));
            if (implementation == null) {
                // if it failed, we look for a parser following this syntax
                // 'CPPLanguage'
                implementation = this
                        .dynamicLanguageImplementationLoad(language
                                .toUpperCase());
                // TODO: Should we try to break the coupling with PACKAGE by try
                // to load the class
    ...
    private Language dynamicLanguageImplementationLoad(String language)
        ...
        try {
            return (Language) this.getClass().getClassLoader()
                    .loadClass(PACKAGE + language + SUFFIX).newInstance();
    ...
    /*
     * This method does simply this: ruby -> Ruby fortran -> Fortran ...
     */
