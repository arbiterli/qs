...
<body>
    ...
    <table border="0" class="summary">
      <th>
        Only show violations that priority less than 3,please check xml report if need more information.   
      </th>
    </table>
    <hr/>
    <xsl:for-each select="file">
		...
		<table border="0" width="100%" class="classcount">
			<tr>
				<th>Total number of violations for this class: <xsl:value-of select="count(violation[@priority &lt; 3])"/></th>
			</tr>
        </table>
        <br/>
    </xsl:for-each>
