...
public class ScpFromMessageBySftp extends ScpFromMessage {
    ...
    public void execute() throws IOException, JSchException {
        ...
        try {
            ...
            // CHECKSTYLE IGNORE Empty_Block FOR NEXT 1 LINES
    ...
    private void getDir(ChannelSftp channel, String remoteFile, File localFile)
        ...
        java.util.Vector<ChannelSftp.LsEntry> files = channel.ls(remoteFile);
    ...
    private void getFile(ChannelSftp channel, ChannelSftp.LsEntry le,
        ...
        if (getPreserveLastModified()) {
            FileUtils.getFileUtils().setFileLastModified(localFile,
                    ((long) le.getAttrs().getMTime()) * ONE_SECOND);
        }
    }
}
