...
public class ScpToMessageBySftp extends ScpToMessage {
     ...
     * @since Ant 1.7
     */
    public ScpToMessageBySftp(boolean verbose, Session session,
            File aLocalFile, String aRemotePath) {
     ...
     * @since Ant 1.6.2
     */
    private ScpToMessageBySftp(boolean verbose, Session session,
            String aRemotePath) {
     ...
     *            the remote path
     */
    public ScpToMessageBySftp(Session session, File aLocalFile,
            String aRemotePath) {
     ...
     *            the remote path
     */
    public ScpToMessageBySftp(Session session, List<Directory> aDirectoryList,
            String aRemotePath) {
    ...
    private void doSingleTransfer() throws IOException, JSchException {
        ...
        try {
            ...
            try {
                ...
                JSchException schException = new JSchException(
                        "Could not send '" + localFile + "' to '" + remotePath
                                + "' - " + e.toString());
    ...
    private void doMultipleTransfer() throws IOException, JSchException {
        ...
        try {
            ...
            try {
                for (Iterator<Directory> i = directoryList.iterator(); i
                        .hasNext();) {
    ...
    private void sendDirectory(ChannelSftp channel, Directory current)
    ...
    private void sendDirectoryToRemote(ChannelSftp channel, Directory directory)
            throws IOException, SftpException {
    ...
    private void sendFileToRemote(ChannelSftp channel, File localFile,
